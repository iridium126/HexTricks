...
@Mod(value = HexTricks.MODID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = HexTricks.MODID, value = Dist.CLIENT)
public class HexTricksClient {
    public HexTricksClient(ModContainer container) {
